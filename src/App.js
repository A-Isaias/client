    ...
    <div className="card text-center">
      ...
      <div className="card-body">
        ...
        <div className="input-group mb-3">
          ...
          className="form-control" value={pais} placeholder="Ingrese País" aria-label="Username" aria-describedby="basic-addon1"/>
        </div> 
        ...
        <div className="input-group mb-3">
          ...
          className="form-control" value={antiguedad} placeholder="Ingrese Antigüedad" aria-label="Username" aria-describedby="basic-addon1"/>
        </div>
      </div>    
      <div class="card-footer text-body-secondary">
        {
          ...
          </div>:<button className='btn btn-success' onClick={add}>Registrar</button>
        }
